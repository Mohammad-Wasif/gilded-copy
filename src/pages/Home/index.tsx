...
export default function Home() {
  ...
  return (
    <>
      ...
      <WholesaleSection />
      <WhyChooseUs />
      <section className="py-16 md:py-32 text-center bg-surface">
        <div className="max-w-2xl mx-auto px-8">
          <h2 className="font-headline text-2xl md:text-4xl text-primary mb-6">Ready to start your next masterpiece?</h2>
          <p className="text-on-surface-variant mb-8 md:mb-12 text-base md:text-lg">Join 5,000+ artisans and design houses sourcing the world's most exquisite materials.</p>
